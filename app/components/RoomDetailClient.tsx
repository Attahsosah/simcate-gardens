...
export default function RoomDetailClient({ room }: RoomDetailClientProps) {
  ...
  const handleImageUpdated = (imageId: string, caption: string) => {
    setRoomImages(prev => 
      prev.map(img => 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              {roomImages && roomImages.length > 0 ? (
                <ImageManager 
                  images={room.previewImageUrl ? 
                    [{ id: 'preview', url: room.previewImageUrl, caption: `${room.name} - Preview` }, ...roomImages] : 
                    roomImages
                  } 
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-8">
              ...
              <p className="text-lg text-gray-700 mb-8 leading-relaxed">{room.description || 'No description available.'}</p>
            ...
            <div className="mt-8">
              ...
              <div className="bg-gray-50 rounded-xl p-6 border-2 border-dashed border-gray-300 hover:border-indigo-400 transition-colors">
                <RoomImageUpload roomId={room.id} onImageUploaded={handleImageUploaded} />
              </div>
            </div>
          </div>
